...
import exc3.business.User;
import exc3.data.UserIO;
import exc3.util.CookieUtil;
...
public class DownloadServlet1 extends HttpServlet {
	...
	public void doGet(HttpServletRequest request,
		...
		if (action.equals("viewAlbums")) {
			...
			url = "/exercise3/view_cookies.jsp";
	...
	public void doPost(HttpServletRequest request,
		...
		// perform action and set URL to appropriate page
		String url = "/exercise3/index.jsp";
	...
	private String checkUser(HttpServletRequest request,
		...
		if (user == null) {
			...
			// if cookie exists, create User object and go to Downloads page
				...
				url = "/exercise3/" + productCode + "_download.jsp";
			}
		}
	...
	private String registerUser(HttpServletRequest request,
		...
		c1.setPath("/exercise3/");                      // allow entire app to access it
		...
		c2.setPath("/exercise3/");                      // allow entire app to access it
		response.addCookie(c2);

		// create and return a URL for the appropriate Download page
		String productCode = (String) session.getAttribute("productCode");
		String url = "/exercise3/" + productCode + "_download.jsp";
		return url;
	}
	...
	private String deleteCookies(HttpServletRequest request,
		...
		String url = "/exercise3/delete_cookies.jsp";
		return url;
	}
